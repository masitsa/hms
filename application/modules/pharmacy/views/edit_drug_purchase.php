<?php
	$container_type_id = $purchase_details->container_type_id;
                            ...
                            <select class="form-control" name="container_type_id">
                                <?php
                                    if(count($container_types) > 0)
                                    {
                                        ...
                                        {
                                            $container_type_id2 = $res->container_type_id;
                                            $container_type_name = $res->container_type_name;
                                            
                                            if($container_type_id2 == $container_type_id)
                                            {
                                                echo '<option value="'.$container_type_id2.'" selected>'.$container_type_name.'</option>';
                                            }
                                            
                                            else
                                            {
                                                echo '<option value="'.$container_type_id2.'">'.$container_type_name.'</option>';
                                            }
                                        }
                                    }
                                ?>
