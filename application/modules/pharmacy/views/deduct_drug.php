        	...
        	<div class="row">
                ...
                <div class="col-md-offset-3 col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="stock_deduction_quantity" placeholder="Deduction Quantity" value="<?php echo set_value('stock_deduction_quantity');?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="stock_deduction_pack_size" placeholder="Pack Size" value="<?php echo set_value('stock_deduction_pack_size');?>">
                        </div>
                    </div>
