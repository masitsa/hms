			...
			foreach ($query->result() as $row)
			{
				...
				'
					<tr>
						...
						<td><a href="'.site_url().'/reception/to-others/'.$patient_id.'/2" class="btn btn-sm btn-primary">Change to others</a></td>
						...
						<!--<td><a href="'.site_url().'/reception/delete_patient/'.$patient_id.'/2" class="btn btn-sm btn-danger" onclick="return confirm(\'Do you really want to delete ?\');">Delete</a></td>-->
					</tr> 
				';
			}
