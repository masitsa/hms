				...
				$result .= 
					'
						<tr>
							...
							<td>'.$visit_time.'</td>
							<td>'.$doctor.'</td>
							<td><a href="'.site_url().'/lab/test/'.$visit_id.'" class="btn btn-sm btn-info">Tests</a></td>
							<td><a href="'.site_url().'/nurse/dental_visit/'.$visit_id.'/a/'.$module.'" class="btn btn-sm btn-danger">History</a></td>
							'.$to_doctor.'
							<td><a href="'.site_url().'/nurse/send_to_labs/'.$visit_id.'" class="btn btn-sm btn-success" onclick="return confirm(\'Send to accounts?\');">To Accounts</a></td>
						</tr> 
					';
			}
